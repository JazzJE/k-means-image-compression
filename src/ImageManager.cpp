...
bool ImageManager::save_image_dat(std::string image_file_name, uint8_t number_of_color_channels, uint8_t number_of_clusters,
...
bool ImageManager::load_image_dat(std::filesystem::path loaded_file_path, uint8_t& number_of_color_channels,
